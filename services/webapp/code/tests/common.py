...
class APIClient(Client):
    ...
    # adding patch and options to test client object
...
class BaseAPITestCase(TestCase):
    ...
    def _login(self, data=None):
        ...
        #self.client.credentials(HTTP_AUTHORIZATION='Token ' + data['key'])
    ...
    def _generate_uid_and_token(self, user):
        # generates uid and token for user on password reset
    ...
    def init(self):
        ...
        if "TESTSERVER" in os.environ:
            ...
            #print "Using external address for tests: {}".format(self.ext_testserver)
    ...
    def verifyusers(self, users):
        ...
        # helper function to verify a user during tests
